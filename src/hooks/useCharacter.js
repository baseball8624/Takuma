...
const CHARACTERS = {
    ignis: {
        ...
        dialoguesByLevel: {
            1: { // Lv1-6: 初々しい小さな炎
                ...
                progress: ['わぁ、すごいすごい！', 'ぽかぽかしてきた！', '楽しいね！'],
                complete: ['やったー！できたね！', 'すごいすごい！', 'えらいえらい！'],
                encourage: ['だいじょうぶだよ！', '一緒にがんばろ！', 'ぼくがついてる！'],
                cheer: ['わーい！さわってくれた！', 'えへへ♪', 'あったかいね！'],
                praise: ['ぼくのこと、すき？', 'またあそぼうね！', 'うれしー！']
            },
            7: { // Lv7-29: 少年期、元気いっぱい
                greeting: ['今日も燃えていこうぜ！', 'おっす！準備はいいか？', '炎のように熱くいこう！'],
                progress: ['いい調子だ！', 'その調子で突き進め！', '燃えてきたな！'],
                complete: ['やったな！最高だぜ！', '完璧だ！お前すごいな！', '今日も最高の1日だった！'],
                encourage: ['まだまだいけるだろ？', 'ここで諦めんなよ！', '俺がついてるぜ！'],
                cheer: ['おっ、なんだ？', '気合入ってんな！', '燃えてきたぜ！'],
                praise: ['お前といると熱くなるぜ！', 'サンキュー！', '最高の相棒だ！']
            },
            30: { // Lv30-99: 青年期、頼もしい
                greeting: ['おはよう。今日も共に戦おう', '炎は絶えず燃え続ける...お前もな', '俺の炎で道を照らしてやる'],
                progress: ['素晴らしい...その調子だ', '炎が力強く燃えている', 'お前の成長が眩しいな'],
                complete: ['見事だ...誇りに思うぞ', '今日という日を勝ち取ったな', '俺たちの炎は消えない'],
                encourage: ['立ち止まるな、前を見ろ', '俺がお前の背中を押してやる', '諦めるにはまだ早い'],
                cheer: ['何か用か？', 'いつでも力になるぞ', '俺の炎が必要か？'],
                praise: ['お前との絆は炎よりも熱い', '共に歩んできた日々を誇りに思う', 'ありがとな...相棒']
            },
            100: { // Lv100+: 伝説、威厳と優しさ
                greeting: ['共に歩んできたこの道...誇らしく思う', '太陽すら凌ぐ炎がここにある', '我が友よ、今日も輝こう'],
                progress: ['その歩みは確かだ', '炎の意志を感じる', '素晴らしい...言葉もない'],
                complete: ['伝説は今日も続く', 'お前と出会えて良かった', '最高の相棒だ'],
                encourage: ['揺らぐことなかれ', '我がともにある限り、道は開ける', '信じている...お前を'],
                cheer: ['我が友よ...何か伝えたいことがあるか？', '炎はお前と共に燃え続ける', '語らずとも...わかっている'],
    ...
    flora: {
        ...
        dialoguesByLevel: {
            ...
            7: { // 少女期、のんびり優しい女の子
                greeting: ['おはよ〜♪ 今日も一緒に成長しよっ♡', 'お花みたいに咲こうね〜♪', '根気よくいこっ♡'],
